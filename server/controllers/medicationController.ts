...
export const createMedication = async (
  ...
  try {
    ...
    if (error instanceof ErrorHandler) {
      ...
      next(
        new ErrorHandler(400, "ERROR", `Error creating medication: ${error}`)
      );
    }
  }
};
...
export const getMedications = async (
  ...
  try {
    ...
    if (error instanceof ErrorHandler) {
      ...
      next(
        new ErrorHandler(400, "ERROR", `Error fetching medications: ${error}`)
      );
    }
  }
};
...
export const getMedication = async (
  ...
  try {
    ...
    if (error instanceof ErrorHandler) {
      ...
      next(
        new ErrorHandler(400, "ERROR", `Error fetching medication: ${error}`)
      );
    }
  }
};
...
export const updateMedication = async (
  ...
  try {
    ...
    if (error instanceof ErrorHandler) {
      ...
      next(
        new ErrorHandler(400, "ERROR", `Error updating medication: ${error}`)
      );
    }
  }
};
    ...
    if (error instanceof ErrorHandler) {
      ...
      next(
        new ErrorHandler(
          400,
          "ERROR",
          `Error deleting medication record: ${error}`
        )
      );
    }
  }
