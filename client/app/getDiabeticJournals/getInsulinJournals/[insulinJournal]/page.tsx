...
export default function GetInsulinJournal({params: { insulinJournal } } : { params: { insulinJournal: string } }) {
  ...
  return (
   ...
   >
    ...
    <SingleEntry label={ 'Date:' } value={formatDate(insulin.date)}></SingleEntry>
    <SingleEntry label={ 'Time:' } value={formatMilitaryTime(insulin.time)}></SingleEntry>
    <SingleEntry label={ 'Type:' } value={insulin.typeOfInsulin}></SingleEntry>
    <SingleEntry label={ 'Units:' } value={ insulin.unit}></SingleEntry>
    <SingleEntry label={ 'Body Site:' } value={ insulin.bodySite }></SingleEntry>
    <SingleEntry label={ 'Notes:' } value={ insulin.notes }></SingleEntry>
   </div>
