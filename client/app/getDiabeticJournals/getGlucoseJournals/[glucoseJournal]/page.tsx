...
export default function GetGlucoseJournal({params: { glucoseJournal } } : { params: { glucoseJournal: string } }) {
  ...
  return (
   ...
   >
    ...
    <SingleEntry label={ 'Date:' } value={formatDate(glucose.date)}></SingleEntry>
    <SingleEntry label={ 'Meal Time:' } value={glucose.mealTime}></SingleEntry>
    <SingleEntry label={ 'Blood Glucose:' } value={glucose.bloodGlucose}></SingleEntry>
    <SingleEntry label={ 'Unit:' } value={ glucose.unit }></SingleEntry>
    <SingleEntry label={ 'Notes:' } value={ glucose.notes }></SingleEntry>
   </div>
