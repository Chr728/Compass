		...
		<div className="bg-eggshell min-h-screen flex flex-col">
			...
			<div className="rounded-3xl bg-white flex flex-col mt-4 mb-44 w-full md:max-w-[800px] md:min-h-[550px] p-4 shadow-[0_32px_64px_0_rgba(44,39,56,0.08),0_16px_32px_0_rgba(44,39,56,0.04)]">
				...
				<div className="font-sans text-start text-darkgrey p-4 text-[14px]">
					...
					and how the law protects You.<br></br> We use Your Personal
					data to provide and improve the Service. By using the
				...
				<div className="font-sans text-start text-darkgrey p-3 text-[14px]">
					...
					<ul className="list-disc">
						...
						<li>
							...
							to provide the Service on behalf of the Company, to
							perform services related to the Service or to assist
				...
				<div className="font-sans text-start text-darkgrey p-3 text-[14px]">
					...
					Service.<br></br> Usage Data may include information such as
					...
					diagnostic data.<br></br> When You access the Service by or
					...
					identifiers and other diagnostic data.<br></br> We may also
				...
				<div className="font-sans text-start text-darkgrey p-3 text-[14px]">
					...
					<ul className="list-disc">
						...
						<li>
							To contact You: To contact You by email, or other
				...
				<div className="font-sans text-start text-darkgrey p-3 text-[14px]">
					...
					legal agreements and policies.<br></br> The Company will
					also retain Usage Data for internal analysis purposes. Usage
				...
				<div className="font-sans text-start text-darkgrey p-3 text-[14px]">
					...
					jurisdiction.<br></br> Your consent to this Privacy Policy
					followed by Your submission of such information represents
					Your agreement to that transfer.<br></br> The Company will
				...
				<div className="font-sans text-start text-darkgrey p-3 text-[14px]">
					...
					information about You from within the Service.<br></br> You
					may update, amend, or delete Your information at any time by
					...
					You have provided to Us.<br></br> Please note, however, that
					We may need to retain certain information when we have a
				...
				<div className="font-sans text-start text-darkgrey p-3 text-[14px]">
					...
					faith belief that such action is necessary to:<br></br>
					<ul className="list-disc">
