	...
	return (
		<div className="bg-eggshell min-h-screen flex flex-col">
			...
			<div className="rounded-3xl bg-white flex flex-col mt-4 mb-44 w-full md:max-w-[800px] md:min-h-[550px] p-4 shadow-[0_32px_64px_0_rgba(44,39,56,0.08),0_16px_32px_0_rgba(44,39,56,0.04)]">
				<div className="font-bold text-start text-darkgrey p-3 text-[40px]">
					PRIVACY POLICY
				</div>
				<div className="font-bold text-start text-darkgrey p-3 text-[16px]">
				...
				<div className="flex justify-between items-center">
					...
					<div className="font-bold text-start text-darkgrey p-3 text-[30px]">
					...
					<div className="font-bold text-start text-darkgrey p-3 text-[14px]">
						...
						<ul>
							...
							<li>
								Application refers to Compass, the software
					...
					<div className="font-bold text-start text-darkgrey p-3 text-[14px]">
						...
						stored on Your device. You can enable or disable access
						to this information at any time, through Your Device
						settings.
					</div>
					<div className="font-bold text-start text-darkgrey p-3 text-[20px]">
					...
					<div className="font-bold text-start text-darkgrey p-3 text-[14px]">
						...
						<ul>
							...
							<li>
								To contact You: To contact You by email, or
