...
} from "@/app/http/bloodPressureJournalAPI";
...
export default function EditBloodPressureJournal({
  params: { bloodPressureJournal },
}: {
  params: { bloodPressureJournal: string };
}) {
  ...
  useEffect(() => {
    ...
    setValues({
      ...
      bloodPressure: `${journalEntry?.systolic || ""}/${
        journalEntry?.diastolic || ""
      }`,
