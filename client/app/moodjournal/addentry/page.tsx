...
export default function AddMoodEntry() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      await createMoodJournal(moodData).then((result) => {
    ...
    validate: async (values) => {
      ...
      if (!values.stressSignals.tired) {
        errors.stressSignals = {
          ...errors.stressSignals,
          tired: "Value required.",
        };
      }
  ...
  return (
    <div
      className="bg-eggshell min-h-screen flex flex-col min-w-full overflow-y-auto"
    ...
    >
      ...
      <p className="text-grey font-sans text-[16px] ml-4 mt-2">
      ...
      >
        ...
        <div className="flex flex-col p-2 rounded-2xl w-full text-darkgrey bg-white shadow-[0_32px_64px_0_rgba(44,39,56,0.08),0_16px_32px_0_rgba(44,39,56,0.04)]">
          <div>
            ...
            />
            <p className="inline-block m-2">How are you?</p>
          </div>
        ...
        <div className="flex flex-col space-y-4 p-2 rounded-2xl w-full text-darkgrey bg-white shadow-[0_32px_64px_0_rgba(44,39,56,0.08),0_16px_32px_0_rgba(44,39,56,0.04)]">
          <span>
            <Image
              ...
              style={{ width: "auto", height: "auto", marginLeft: "4px" }}
            />
            <p className="inline-block m-2">Stress Signals</p>
          </span>

          <div>
            <label htmlFor="tired" className="text-grey">
              I feel tired.
            </label>
            <br />
            <select
            ...
            {formik.touched.stressSignals &&
              formik.touched.stressSignals.tired &&
              formik.errors.stressSignals &&
          ...
          <div>
            <label htmlFor="sleep" className="text-grey">
            ...
            {formik.touched.stressSignals &&
              formik.touched.stressSignals.sleep &&
              formik.errors.stressSignals &&
          ...
          <div>
            <label htmlFor="hunger" className="text-grey">
              I'm not hungry.
            </label>
            <br />
            <select
            ...
            {formik.touched.stressSignals &&
              formik.touched.stressSignals.hunger &&
              formik.errors.stressSignals &&
          ...
          <div>
            <label htmlFor="overeating" className="text-grey">
              I ate too much.
            </label>
            <br />
            <select
            ...
            {formik.touched.stressSignals &&
              formik.touched.stressSignals.overeating &&
              formik.errors.stressSignals &&
          ...
          <div>
            <label htmlFor="depressed" className="text-grey">
            ...
            {formik.touched.stressSignals &&
              formik.touched.stressSignals.depressed &&
              formik.errors.stressSignals &&
          ...
          <div>
            <label htmlFor="pressure" className="text-grey">
            ...
            {formik.touched.stressSignals &&
              formik.touched.stressSignals.pressure &&
              formik.errors.stressSignals &&
          ...
          <div>
            <label htmlFor="attention" className="text-grey">
            ...
            {formik.touched.stressSignals &&
              formik.touched.stressSignals.attention &&
              formik.errors.stressSignals &&
          ...
          <div>
            <label htmlFor="anxiety" className="text-grey">
            ...
            {formik.touched.stressSignals &&
              formik.touched.stressSignals.anxiety &&
              formik.errors.stressSignals &&
          ...
          <div>
            <label htmlFor="anger" className="text-grey">
            ...
            {formik.touched.stressSignals &&
              formik.touched.stressSignals.anger &&
              formik.errors.stressSignals &&
          ...
          <div>
            <label htmlFor="headache" className="text-grey">
            ...
            {formik.touched.stressSignals &&
              formik.touched.stressSignals.headache &&
              formik.errors.stressSignals &&
