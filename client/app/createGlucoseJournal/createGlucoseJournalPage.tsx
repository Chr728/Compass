	...
	const formik = useFormik({
		...
		onSubmit: async (values) => {
			try {
				...
				const result = await createGlucoseJournal(data).then(
					(result) => {
	...
	return (
		<div className="bg-eggshell min-h-screen flex flex-col">
			<SpanHeader
				...
				headerText="Create Glucose Measurement"></SpanHeader>
			<form
				...
				<div className="mt-3">
					...
					<select
						...
						<option
							className="text-darkgrey"
							value="30min after lunch">
							30min after lunch
						</option>
						<option
							className="text-darkgrey"
							value="2hrs after lunch">
							2hrs after lunch
						</option>
						...
						<option
							className="text-darkgrey"
							value="30min after dinner">
							30min after dinner
						</option>
						<option
							className="text-darkgrey"
							value="2hrs after dinner">
							2hrs after dinner
						</option>
						...
						{formik.touched.bloodGlucose &&
							...
							((!formik.values.bloodGlucose && (
								...
								(formik.values.bloodGlucose <= 0 && (
									<p className="text-red text-[14px]">
										You can't enter a negative Blood Glucose
										or a Blood Glucose of zero.
									</p>
								)))}
					</div>
