  ...
  return (
    <div className="bg-eggshell p-2 min-h-screen flex flex-col">
      ...
      <Link href="/getMedications">
            <div className="rounded-3xl  relative flex flex-col  w-full md:max-w-[800px] md:h-[600px] p-5 mb-6" style={{backgroundColor: 'var(--Black, #2C2738)' }}>
      ...
      <Link href="/clinicLocator">
            <div className="rounded-3xl  relative flex flex-col  w-full md:max-w-[800px] md:h-[600px] p-5 " style={{backgroundColor: '#FF7171' }}>
                <div>
                    <p className="text-[18px] text-white font-IBM Plex Sans font-bold text-start">
                        Clinic Locator
                    </p>
