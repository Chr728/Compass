...
export async function getActivityJournal(
	...
	try {
		...
		logger.info(
			`Activity journal fetched successfully for user ${activityJournalId}`
		);
		if (!response.ok) {
			logger.error("Failed to retrieve activity journal entry");
			throw new Error(`Failed to retrieve activity journal entry`);
		}
		const data = await response.json();
		return data;
	} catch (error) {
...
export async function createActivityJournal(
	...
	try {
		...
		if (!response.ok) {
			...
			throw new Error(`Failed to create activity journal entry`);
		}
		const data = await response.json();
		return data;
	} catch (error) {
...
export async function updateActivityJournal(
	...
	try {
		...
		logger.info(
			`Activity journal entry updated successfully for user ${activityJournalId}`
		);
		if (!response.ok) {
			logger.error("Failed to update activity journal entry");
			throw new Error(`Failed to update activity journal entry`);
		}
		const data = await response.json();
		return data;
	} catch (error) {
...
export async function deleteActivityJournal(
	...
	try {
		...
		logger.info(
			`Activity journal entry deleted successfully for user ${activityJournalId}`
		);
		if (!response.ok) {
			logger.error("Failed to delete activity journal entry");
			throw new Error(`Failed to delete activity journal entry`);
		}
