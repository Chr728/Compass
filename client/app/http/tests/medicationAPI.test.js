...
import { getMedications, getMedication, createMedication, updateMedication, deleteMedication } from '../medicationAPI';
...
describe('getMedications', () => {
  ...
  it('should fetch medications for the user', async () => {
    ...
    expect(mockFetch).toHaveBeenCalledWith(`${process.env.NEXT_PUBLIC_API_URL}/api/medication/user/${mockUserId}`, {
      method: 'GET',
      headers: {
  ...
  it('should throw an error if the user is not signed in', async () => {
    ...
    await expect(getMedications()).rejects.toThrow('No user is currently signed in.');
  });
  ...
  it('should throw an error if the fetch request fails', async () => {
    ...
    await expect(getMedications()).rejects.toThrow('Failed to retrieve Medications for user');
  });
});
...
describe('getMedication', () => {
  ...
  it('should throw an error if the user is not signed in', async () => {
    ...
    await expect(getMedication()).rejects.toThrow('No user is currently signed in.');
  });
...
describe('createMedication', () => {
  ...
  it('should throw an error if the medication entry creation fails', async () => {
    ...
    await expect(createMedication(mockUserId, mockMedicationData)).rejects.toThrow(
      `Failed to create Medication entry for user`
    );
  });
});
...
describe('updateMedication', () => {
  ...
  it('should throw an error if the medication entry update fails', async () => {
    ...
    await expect(
      ...
      `Failed to update Medication entry for user`
    );
  });
});
...
describe('deleteMedication', () => {
  ...
  it('should delete a medication entry for the user', async () => {
    ...
    expect(mockFetch).toHaveBeenCalledWith(`${process.env.NEXT_PUBLIC_API_URL}/api/medication/${mockMedicationId}`, {
      method: 'DELETE',
      headers: {
        Authorization: `Bearer ${mockToken}`,
      },
    });
    expect(result).toEqual({ message: 'Medication entry deleted successfully' });
  });
