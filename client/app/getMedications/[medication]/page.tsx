...
export default function GetMedication({params: { medication } } : { params: { medication: string } }) {
  ...
  return (
   ...
   >
    ...
    <SingleEntry label={ 'Medication Name:' } value={medicationdata.medicationName}></SingleEntry>
    <SingleEntry label={ 'Start Date:' } value={formatDate(medicationdata.dateStarted)}></SingleEntry>
    <SingleEntry label={ 'Time:' } value={formatMilitaryTime(medicationdata.time)}></SingleEntry>
    <SingleEntry label={ 'Dosage:' } value={medicationdata.dosage}></SingleEntry>
    <SingleEntry label={ 'Unit:' } value={ medicationdata.unit}></SingleEntry>
    <SingleEntry label={ 'Frequency:' } value={ medicationdata.frequency }></SingleEntry>
    <SingleEntry label={ 'Route:' } value={medicationdata.route}></SingleEntry>          
    <SingleEntry label={ 'Notes:' } value={medicationdata.notes}></SingleEntry>          
   </div>
